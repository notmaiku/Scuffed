...
public class TileGenerator : MonoBehaviour
{
    ...
    void generateTile(){
        ...
        TerrainType[,] heatTerrainTypeMap = TextureBuilder.CreateTerrainType(heatMap, heatTerrainTypes);
        TerrainType[,] moistureTerrainTypeMap = TextureBuilder.CreateTerrainType(moistureMap, moistureTerrainTypes);
